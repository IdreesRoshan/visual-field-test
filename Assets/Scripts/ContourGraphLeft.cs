...
public class ContourGraphLeft : MonoBehaviour
{
    ...
    void readCSV(int contour) { 
        ...
        switch (contour){
            case 1:
               dataLines = File.ReadAllLines(Application.dataPath + "/results4.csv");
               break;
            case 2:
               dataLines = File.ReadAllLines(Application.dataPath + "/results5.csv");
                break;
            case 3:
                dataLines = File.ReadAllLines(Application.dataPath + "/results6.csv");
                break;
        }
